...
//            String mobile=request.getParameter("mobile");/
           ...
           String id=session.getAttribute("id").toString();
            String op = request.getParameter("otpver");
            ...
            if (rs.next()) {
                ...
                if(nppan.equals(pannumber)&& otp.equals(op) ){
                stmt = con.createStatement();
            ...
            SendEmail.mailSnd(email, "Bank has been created your account  Your acc no: "+acc+". From SBI Bank");
