...
<!--                <style>
                      /* Style the images so they fit nicely in the marquee */
                      img {
                        width: 100px;
                        height: 100px;
                        margin: 10px;
                  ...
                  <body>
                    <marquee behavior="scroll" direction="left">
                       Add the images to the marquee tag 
                      <img src="images/bank/b1.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b2.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b3.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b4.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b5.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b6.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b7.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b8.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b9.png" onmouseover="this.stop();" onmouseout="this.start();" />
                      <img src="images/bank/b10.png" onmouseover="this.stop();" onmouseout="this.start();" />
                  
                    </marquee>-->
                  
<img src="images/bank/gg.gif" onmouseover="this.stop();" onmouseout="this.start();" />
		...
		<div class="container">  
			...
			<div class="team-info">
				<div class="col-md-4 team-grids">
					<img class="img-responsive" src="images/vj1.jpg" alt="">
				...
				<div class="col-md-4 team-grids">
					<img class="img-responsive" src="images/dk2.jpg" alt="">
					<div class="agileits-captn"> 
						<div class="social-icons"> 
							<ul>
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
				...
				<div class="col-md-4 team-grids">
					<img class="img-responsive" src="images/dk3.jpg" alt="">
					<div class="agileits-captn"> 
						<div class="social-icons"> 
							<ul>
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
					...
					<h4>Dhiraj Khairnar</h4>
					<p>             </p>
				</div>
				<div class="col-md-4 team-grids">
					<img class="img-responsive" src="images/gk4.jpg" alt="">
					<div class="agileits-captn"> 
						<div class="social-icons"> 
							<ul>
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
	...
	<div class="container">	
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 stats-grid stats-grid-3 gridw3">
				...
				<div class="numscroller" data-slno='1' data-min='0' data-max='5' data-delay='3' data-increment="1">80</div>
				<h4>collabaration</h4>
			</div>
			<div class="col-md-3 col-sm-3 stats-grid stats-grid-4 gridw3">
				<i class="fa fa-users" aria-hidden="true"></i>
				<div class="numscroller" data-slno='1' data-min='0' data-max='4' data-delay='3' data-increment="1">90</div>
				<h4>Members</h4>
			</div>
			<div class="clearfix"></div> 
