...
<div class="header">
		<nav class="navbar navbar-default link-effect-8" id="link-effect-8">
					<div class="navbar-header">
						...
						<h1><a href="bank_dashboard.jsp">Secure<span><i class="fa fa-credit-card-alt" aria-hidden="true"></i></span>Kyc</a></h1>
					</div>
					
					<!-- navbar-header -->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a class=" active" href="bank_dashboard.jsp">Home</a></li>
                                                        <li><a href="CreateAccount.jsp" class="">Create Account</a></li>
                                                        <li><a href="Account.jsp" class="">View Account</a></li>
                                                        <!--<li><a href="fundtrans/fer.jsp" class="">Fund Transfer</a></li>-->

                                                        <li><a href="logout.jsp" class="">Log Out</a>
						</ul>
					</div>
