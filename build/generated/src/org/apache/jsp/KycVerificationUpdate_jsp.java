...
public final class KycVerificationUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (flash_message != null) {
      ...
      out.write("        <br>\n");
      out.write("    <center>\n");
      out.write("        <form action=\"create_account\" method=\"POST\" >\n");
      out.write("             <table>\n");
      out.write("  <tr>\n");
      out.write("     <th>ID</th>\n");
      ...
      out.write("          ");
        ...
        try {
                ...
                String q="select `pan_number` from kyc_details where (select id from users where kyc_details.uid=users.id)";
      ...
      out.write("</td>\n");
      out.write("         <td>");
      out.print(request.getParameter("mobno"));
      out.write("</td>\n");
      out.write("         <td>");
      out.print(request.getParameter("email"));
      out.write("</td>\n");
      out.write("         <td>");
      out.print(request.getParameter("addre"));
      out.write("</td>\n");
      out.write("         <td>");
      out.print(rs.getString(1));
      out.write("</td>\n");
      out.write("      </tr> \n");
      out.write("            <!--<input id=\"firstname\" class=\"input\" type=\"text\" name=\"pname\" placeholder=\" \" value=\"");
//=request.getParameter("pname")
      out.write("\" />-->\n");
      out.write("<!--              <input id=\"firstname\" class=\"input\" type=\"text\" name=\"mobno\" placeholder=\" \" value=\"");
//=request.getParameter("mobno")
      out.write("\" />\n");
      out.write("              <input id=\"firstname\" class=\"input\" type=\"text\" name=\"email\" placeholder=\" \" value=\"");
//=request.getParameter("email")
      out.write("\" />\n");
      out.write("              <input id=\"firstname\" class=\"input\" type=\"text\" name=\"addre\" placeholder=\" \" value=\"");
//=request.getParameter("addre")
      out.write("\" />-->\n");
      out.write("      ");
      ...
      out.write("      <div class=\"title\">Verify Kyc</div>\n");
      out.write("      <!--<div class=\"subtitle\">Let's create your account!</div>-->\n");
      out.write("      <div class=\"input-container ic1\">\n");
      out.write("          <input id=\"firstname\" class=\"input\" type=\"text\" name=\"pannumber\" placeholder=\" \" />\n");
      out.write("        <div class=\"cut\"></div>\n");
      out.write("        <label for=\"firstname\" class=\"placeholder\">Unique ID</label>\n");
      out.write("      </div>\n");
      out.write("     \n");
      out.write("      <hr>\n");
      out.write("      <label style=\"color: white\">OR</label>\n");
      out.write("      <div class=\"input-container ic2\">\n");
      out.write("          <input id=\"email\" class=\"input\" type=\"file\" name=\"adharfile\"  placeholder=\" \" />\n");
      out.write("        <div class=\"cut cut-short\"></div>\n");
      out.write("        <label for=\"email\" class=\"placeholder\">Adhar File</>\n");
      out.write("      </div>\n");
      out.write("       <div class=\"input-container ic2\">\n");
      out.write("           <input id=\"email\" class=\"input\" type=\"file\" name=\"panfile\" placeholder=\" \" />\n");
      out.write("        <div class=\"cut cut-short\"></div>\n");
      out.write("        <label for=\"email\" class=\"placeholder\">Pan Files</>\n");
      out.write("      </div>\n");
      out.write("       \n");
