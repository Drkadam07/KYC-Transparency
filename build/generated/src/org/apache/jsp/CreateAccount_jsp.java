    ...
    if (flash_message != null) {
      ...
      out.write("          ");
        ...
        stmt = con.createStatement();
         String sql="SELECT * FROM `users` WHERE NOT EXISTS (SELECT * FROM `bank_acc` WHERE users.mobile = bank_acc.mobile)";
      ...
      out.write("          <input id=\"lastname\" class=\"input\" type=\"number\" name=\"mobno\" minlength=\"10\" maxlength=\"10\" placeholder=\" \" />\n");
      out.write("        <div class=\"cut\"></div>\n");
      out.write("        <label for=\"lastname\" class=\"placeholder\">Mobile Number</label>\n");
      out.write("      </div>\n");
      out.write("      <div class=\"input-container ic2\">\n");
      out.write("          <input id=\"email\" class=\"input\" type=\"email\" name=\"email\" placeholder=\" \" />\n");
