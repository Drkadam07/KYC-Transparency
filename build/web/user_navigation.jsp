...
<div class="header">
		<nav class="navbar navbar-default link-effect-8" id="link-effect-8">
					<div class="navbar-header">
						...
						<h1><a href="Welcome.jsp">Secure<span><i class="fa fa-credit-card-alt" aria-hidden="true"></i></span>Kyc</a></h1>
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a class=" active" href="Welcome.jsp">Home</a></li>
                                                        <li><a href="upload_kyc.jsp" class="">Upload kyc Details</a></li>
                                                        <li><a href="fundtransfer.jsp" class="">Fund Transfer</a></li>
